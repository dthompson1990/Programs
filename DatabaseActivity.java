...
public class DatabaseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        priceNewtext = (EditText) findViewById(R.id.PriceNewText);


        semesterSpinner = (Spinner) findViewById(R.id.Sem);
        departmentSpinner = (Spinner) findViewById(R.id.Dep);
        courseSpinner = (Spinner) findViewById(R.id.Cour);
    ...
    public void updatePrice(View view){
        price = priceNewtext.getText().toString();
        priceNewtext.setText("");
        DatabaseAccess databaseAccess = DatabaseAccess.getInstance(this);
        databaseAccess.open();
        databaseAccess.updatePrice(price, semesterSpinner.getSelectedItem().toString(), departmentSpinner.getSelectedItem().toString(), courseSpinner.getSelectedItem().toString(), sectionSpinner.getSelectedItem().toString());
